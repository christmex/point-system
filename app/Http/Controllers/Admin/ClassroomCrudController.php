...
class ClassroomCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setEntityNameStrings('Ruang Kelas', 'Daftar Ruang Kelas');
    }
    ...
    {
        CRUD::column('classroom_name')->label('Nama kelas')->limit(1000);
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('classroom_name')->label('Nama Kelas');
